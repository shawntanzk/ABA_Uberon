...
write.table(diff_old_new, file='/Users/shawntan/documents/GitHub/ABA_Uberon/src/ontology/old-to-new.tsv', quote=FALSE, sep='\t')
write.table(diff_new_old, file='/Users/shawntan/documents/GitHub/ABA_Uberon/src/ontology/new-to-old.tsv', quote=FALSE, sep='\t')
